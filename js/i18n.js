...
(function () {
  ...
  var I18N = {
    en: {
      ...
      'about.eduSub': 'B.Sc. Software Engineering · GPA 3.32 / 4.0 · 2022–2026',
      ...
      'proj.p5.cat': 'AI · ERP · Telegram',
      'proj.p5.name': 'AffuraBot — Telegram ERP Assistant',
      'proj.p5.desc': 'A fully-Arabic, menu-driven Telegram bot on top of the live AffuraAI ERP. Type an order number and drill from order to line to work-order detail — dashboards, stock, production, consumption and wastage served as text and inline keyboards. A .NET 10 long-polling worker with zero changes to the main app.',
      'proj.p5.h1': 'Fully Arabic (RTL) menu engine navigating 8 ERP sections via inline keyboards',
      'proj.p5.h2': 'Order → line → work-order drill with a generic pager (20/page)',
      'proj.p5.h3': 'Default-deny whitelist & read-only HTTP client — fully isolated from the ERP',
      'proj.p5.h4': 'Token-free test suite: mocked Telegram & API with xUnit',
    ...
    tr: {
      ...
      'about.eduSub': 'Yazılım Mühendisliği Lisans · GPA 3.32 / 4.0 · 2022–2026',
      'about.loc': 'Gaziantep, Türkiye',
      ...
      'proj.p5.cat': 'AI · ERP · Telegram',
      'proj.p5.name': 'AffuraBot — Telegram ERP Asistanı',
      'proj.p5.desc': 'Canlı AffuraAI ERP’nin üstünde menü-güdümlü, tamamen Arapça bir Telegram botu. Sipariş numarasını yaz; siparişten kaleme, kalemden iş emri detayına in — dashboard, stok, üretim, tüketim ve fire metin + inline klavye olarak gelir. Ana uygulamaya sıfır dokunuşlu .NET 10 long-polling worker.',
      'proj.p5.h1': '8 ERP bölümünü inline klavyelerle gezen tamamen Arapça (RTL) menü motoru',
      'proj.p5.h2': 'Sipariş → kalem → iş emri drill akışı, jenerik sayfalama (20/sayfa)',
      'proj.p5.h3': 'Default-deny whitelist + salt okunur HTTP istemci — ERP’den tam izole',
      'proj.p5.h4': 'Token’sız test paketi: xUnit ile mock Telegram & API',
